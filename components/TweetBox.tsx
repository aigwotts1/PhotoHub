...
function TweetBox({setTweets}:Props) {
  ...
  return (
    ...
    <div className='flex space-x-2 p-5'>
        ...
        src={session?.user?.image||'https://links.papareact.com/gll'} alt="background-image"/>
        ...
        <div className='flex flex-1 items-center pl-2'>
            <form className='flex flex-1 flex-col'>
                ...
                type="text" 
                placeholder='So you wanna post!!!'
                name="" id="" 
                className='h-24 w-full text-xl outline-none placeholder:text-xl'/>
                <div className='flex items-center'>
                <div className='flex space-x-2 text-green-500 flex-1'>
                ...
                <button onClick={handleSubmit} disabled={!input || !session} className='bg-green-500 px-4 py-2 font-bold text-white rounded-full disabled:opacity-40'>Post</button>
                </div>
                {imageUrlBoxIsOpen && (
                    <form className='mt-5 flex rounded-lg bg-green-400 py-2 px-4'>
                        <input
                        ref={imageInputRef}
                         className='flex-1 bg-transparent p2 text-white outline-none placeholder:text-white' type="text"
